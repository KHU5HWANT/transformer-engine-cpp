...
\midrule
Per-token cost   & syscall + kernel→user copy & pointer dereference \\
...
\textbf{Why fuse?}  The naïve approach chains four nodes:
...
\subsection{Smoke Test Execution Log (400 Steps Curriculum)}

To definitively prove the engine's memory safety, dataloader multi-file transitioning, and end-to-end autograd stability, a 400-step smoke test was executed without a single segmentation fault or memory leak. The engine successfully transitioned across three datasets (\texttt{math.bin}, \texttt{stories.bin}, \texttt{wiki.bin}) and saved model checkpoints.
...
║  ~params     ≈   173696                 ║
╠══════════════════════════════════════════════╣
║  Phase 0 MATH    steps [0,        100)      ║
║  Phase 1 STORIES steps [   100,    200)      ║
║  Phase 2 WIKI    steps [   200,    400)      ║
╚══════════════════════════════════════════════╝
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  step=     0  phase=   MATH  loss=  5.6744  lr=1.00e-03  speed=    0.0 step/s

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  CURRICULUM TRANSITION: MATH → STORIES  (step 100)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  [CKPT] Saved 1102 KB → checkpoint_phase0.bin
  [INFO] Dataset swapped to data/stories.bin
         Tokens available: 1904212181

  step=   100  phase=STORIES  loss=  9.0678  lr=1.00e-03  speed=    0.3 step/s

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  CURRICULUM TRANSITION: STORIES → WIKI  (step 200)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  [CKPT] Saved 1102 KB → checkpoint_phase1.bin
  [INFO] Dataset swapped to data/wiki.bin
         Tokens available: 273058991

  step=   200  phase=   WIKI  loss=  3.4399  lr=1.00e-03  speed=    0.3 step/s
  step=   300  phase=   WIKI  loss=  2.8562  lr=1.00e-03  speed=    0.3 step/s

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  TRAINING COMPLETE  (400 steps)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
